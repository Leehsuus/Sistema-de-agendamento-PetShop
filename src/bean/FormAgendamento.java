...
public class FormAgendamento extends JPanel {
    ...
    public void populaCmbDonosAnimais() {
        String sql = "select Clientes_idClientes from Animais";
        ...
        try {
            ...
            while (rs.next()) {
                cmbDono.addItem(rs.getString("Clientes_idClientes"));
            }
        ...
        cmbDono.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent evt) {
                if (cmbDono.getSelectedItem() != null) {
                    //listarAnimais();
                    ...
                    try {
                        pst = con.prepareStatement(sql);
                        pst.setString(1, cmbDono.getSelectedItem() + "%");
                        rs = pst.executeQuery();

                        while (rs.next()) {
                            cmbAnimal.addItem(rs.getString("NomeAnimal"));
                        }
                    } catch (SQLException ex) {
                        JOptionPane.showMessageDialog(null, ex);
                    }
    ...
    private void initComponents() {
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), cmbDono, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), cmbAnimal, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        org.jdesktop.swingbinding.JComboBoxBinding jComboBoxBinding = org.jdesktop.swingbinding.SwingBindings.createJComboBoxBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, serviçosList, jComboBox3);
